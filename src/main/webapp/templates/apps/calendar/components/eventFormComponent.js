(function ($) {
    ...
    KEditor.components['eventForm'] = {
        settingEnabled: true,

        settingTitle: 'Event Form',

        initSettingForm: function (form, keditor) {
            flog('initSettingForm "eventForm" component');

            return $.ajax({
                url: '_components/eventForm?settings',
                type: 'get',
                dataType: 'html',
        ...
        showSettingForm: function (form, component, keditor) {
            flog('showSettingForm "eventForm" component');
