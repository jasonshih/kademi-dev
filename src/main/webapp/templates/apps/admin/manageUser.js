...
function doSearch() {
    var query = $("#userQuery").attr("value");
...
function initAddToGroup() {
    ...
    $("#addToGroupModal .groups a").click(function(e) {
        e.preventDefault();        
        var href = $(e.target).attr("href");
        log("add to group", href);
        var checkBoxes = $(".Info").find("tbody td input:[name=toRemoveId]:checked");
