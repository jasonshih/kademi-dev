...
function showRegisterOrLoginModal(callbackOnLoggedIn) {
    ...
    if (modal.length === 0) {
        modal = $("<div class='modal fade'><div class='modal-dialog'><div class='modal-content'><div class='modal-header'><button type='button' class='close' data-dismiss='modal' aria-hidden='true'>&times;</button><h3>Login or Register</h3></div><div class='modal-body'>Please wait...</div></div></div></div>");
        $("body").append(modal);
