...
function initProgramEditing(programsUrl) {
    ...
    form.forms({
        callback: function(resp) {
            ...
            if (resp.nextHref) {
                ...
                var del = $("<a class='DeleteProgram' title='Delete program' href='#'><span class='Hidden'>Delete program</span></a>");
    ...
    $("body").on("click", "div.Program a.DeleteProgram", function(e) {
        ...
        programHref = getFolderPath(programHref); // strip the /manageCourses part
