...
CKEDITOR.addTemplates('default',{
...

    {
        ...
        html:'<div class="activity"><p>Type the text here</p></div><br/>'
    },
    {
        title:'Dropdown1',
        image:'icon_dropdown.gif',
        description:'A sub-heading with a dropdown button which reveals its content.',
        html:'<div class="dropdown"><h6>Type the title here</h6><div><p>Type the text here</p></div></div><br/>'
    },
    {
        title:'Dropdown2',
        image:'icon_dropdown.gif',
        description:'A sub-heading with a dropdown button which reveals its content, with an accentuated bacground.',
        html:'<div class="dropdown accentuated"><h6>Type the title here</h6><div><p>Type the text here</p></div></div><br/>'
    },
    ...
    },
    {
        ...
        html:'<div class="accentuated"><p>Type the text here</p></div><br/>'
    },
    {
        ...
        html:'<div class="lightbulb"><div class="dropdown"><h6>Type the title here</h6><div><p>Type the text here</p></div></div></div><br/>'
    },
    {
        title:'Key learning point section',
        image:'icon_key_learning.gif',
        description:'A sub-heading 2 with a dropdown button which reveals its content.',
        html:'<div class="keyPoint"><h4>Key learning point</h4><div><p>Type the text here</p></div></div><br/>'
    },
    {
    ...
    },
    {
        ...
        html:'<table width="100%" class="striped"><thead><tr><th></th><th></th><th></th></tr></thead><tbody><tr><td></td><td></td><td></td></tr><tr><td></td><td></td><td></td></tr></tbody></table><br/>'
    },
    {
    ...
    },
    {
        ...
        html:'<table width="100%" class="plain page-2cols"><tbody><tr><td width="50%"></td><td></td><td width="50%"></td></tr></tbody></table><br/>'
    }
    ]
});
