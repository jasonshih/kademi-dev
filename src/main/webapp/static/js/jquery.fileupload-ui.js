/*
 * HACKED VERSION FOR VIDEO EDITOR!!!!! DANGER!!!
 *
 *
        ...
        options: {
            ...
            // Callback for successful uploads:
                ...
                if ( data.files )
                {
                    ...
                    var initSelect = getInitialSelect();
                    var pathID = initSelect.substring(0, initSelect.lastIndexOf('/')+1);
                    startUpload(filename);
                    methodInvoke(pathID + filename);
                }
                var that = $(this).data('fileupload'),
                template,
                preview;
