...
// load the css when DOM is ready
		$(function () {
			...
			var u = navigator.userAgent.toLowerCase(),
				...
				css_string = '' +
					'.jstree ul, .jstree li { vertical-align:top; display:block; margin:0 0 0 0; padding:0 0 0 0; list-style-type:none; } ' +
					'.jstree li { display:block; min-height:18px; line-height:18px; white-space:nowrap; margin-left:18px; min-width:18px; } ' +
					'.jstree-rtl li { margin-left:0; margin-right:18px; } ' +
					'.jstree > ul > li { margin-left:0px; } ' +
					'.jstree-rtl > ul > li { margin-right:0px; } ' +
					'.jstree ins { display:inline-block; text-decoration:none; width:18px; height:18px; margin:0 0 0 0; padding:0; vertical-align:text-bottom; } ' +
					'.jstree a { font-family: "Open Sans",sans-serif; font-size: 13px; display:inline-block; line-height:16px; height:16px; color:black; white-space:nowrap; text-decoration:none; padding:1px 2px; margin:0; } ' +
					...
					switch (!0) {
						...
						case (!s.data && !!s.ajax) || (!!s.data && !!s.ajax && obj && obj !== -1):
							...
							success_func = function (d, t, x) {
								log("success_func", d, t, x);
								var sf = this.get_settings().json_data.ajax.success;
								if (sf) {
									d = sf.call(this, d, t, x) || d;
									log("success_func2", d, sf);
								}
