(function (factory) {
    ...
    function MTree(target, options) {
        ...
        $.getStyleOnce('/static/jquery.mtree/1.0.0/jquery.mtree.css');
        $.getStyleOnce('/static/jquery.mtree/1.0.0/jstree/dist/themes/default/style.min.css');
        
        $.when(
            $.getScriptOnce('/static/jquery.mtree/1.0.0/jstree/dist/jstree.min.js')
        ).then(function () {
            self.target = target;
