...
(function ($) {
    flog('[jquery.forms] DEPRECATED options of 1.1.3 which will be removed 1.2.0:');
    flog('********************************************');
    ...
    $.fn.forms.DEFAULT = {
        ...
        validate: function (form, config) {
            flog('[jquery.forms] Default validate of v1.1.3', form, config);
        ...
        onValid: function (form, config) {
            flog('[jquery.forms] Default onValid of v1.1.3', form, config);
        },
        onInvalid: function (form, config) {
            flog('[jquery.forms] Default onInvalid of v1.1.3', form, config);
        },
        allowPostForm: true,
        beforePostForm: function (form, config, data) {
            flog('[jquery.forms] Default beforePostForm of v1.1.3', form, config, data);

            return data;
        },
        onSuccess: function (resp, form, config) {
            flog('[jquery.forms] Default onSuccess of v1.1.3', resp, form, config);
        },
