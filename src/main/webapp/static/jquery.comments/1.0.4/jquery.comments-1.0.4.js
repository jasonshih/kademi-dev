        ...
        var config = $.extend({
            ...
            'renderCommentFn': function (user, date, comment, commentId) {
                ...
                if (outerDiv.length === 0) {
                    ...
                    var replyTo = $('<a class="reply" href="#">Reply</a>');
                    var replyTextContainer = $('<div class="control-group"></div>');
                    var replyText = $('<textarea class="form-control replyText"></textarea').hide();
                    replyTextContainer.append(replyText);
                    ...
                    replyTo.on('click', function (e) {
                        ...
                        var btn = $(this);
                        flog(btn);
                        var r = btn.parent().find('.replyText');
                        if (r.is(':visible')) {
                            r.hide();
                        } else {
                            r.show();
                    ...
                    outerDiv.append(replyTo);
                    outerDiv.append(replyTextContainer);
