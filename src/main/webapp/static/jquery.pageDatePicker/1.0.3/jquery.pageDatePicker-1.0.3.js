    ...
    PageDatePicker.prototype = {
        ...
        initOriginRange: function () {
            ...
            if (cookieStartDate && cookieEndDate) {
                flog('[jquery.pageDatePicker] Init value: ' + cookieStartDate + ' - ' + cookieEndDate + ' - ' + options.dateFormat);
                ...
                if (trigger.length > 0) {
                    ...
                    picker.locale.format = options.dateFormat;
                    picker.setStartDate(cookieStartDate);
                    picker.setEndDate(cookieEndDate);
