 ...
 * modified to work with standard kademi file browser
 */
...
( function() {
	CKEDITOR.dialog.add( 'link', function( editor ) {
        ...
        // init
        $('head').append('<link href="/static/jquery.mselect/1.1.0/jquery.mselect-1.1.0.css" rel="stylesheet">');
                ...
                $.getScriptOnce('/static/jquery.mselect/1.1.0/jquery.mselect-1.1.0.js', function(){
                    $('.btnBrowseFiles').mselectAll({
                        ...
                        onSelectFile: function (url, relUrl, type, hash) {
							...
							that.getContentElement( 'info', 'url').setValue(relUrl);
