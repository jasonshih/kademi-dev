                ...
                id: "info", label: a.lang.table.title, elements: [{
                    ...
                    {type: "html", align: "right", html: ""}, {
                        type: "vbox", padding: 0, children: [{
                            ...
                            type: "html",
                            html: '<label>Bootstrap Styles</label>'
                        }, {
                            type: "checkbox",
                            id: "chkCondensed",
                            default: '',
                            ...
                            setup: function (a) {
                                this.setValue(a.hasClass("table-condensed") ? "checked" : "");
                            },
                            commit: function (a, d) {
                                if (this.getValue()) {
                                    setTimeout(function () {
                                        d.addClass("table-condensed");
                                    }, 200);
                                } else {
                                    setTimeout(function () {
                                        d.removeClass("table-condensed");
                                    }, 200);
                                }
                            }
                        }, {
                            ...
                            label: 'Striped Table',
                            setup: function (a) {
                                this.setValue(a.hasClass("table-striped") ? "checked" : "");
                            },
                            commit: function (a, d) {
                                if (this.getValue()) {
                                    setTimeout(function () {
                                        d.addClass("table-striped");
                                    }, 200);
                                } else {
                                    setTimeout(function () {
                                        d.removeClass("table-striped");
                                    }, 200);
                                }
                            }
                        }, {
                            ...
                            label: 'Hover Table',
                            setup: function (a) {
                                this.setValue(a.hasClass("table-hover") ? "checked" : "");
                            },
                            commit: function (a, d) {
                                if (this.getValue()) {
                                    setTimeout(function () {
                                        d.addClass("table-hover");
                                    }, 200);
                                } else {
                                    setTimeout(function () {
                                        d.removeClass("table-hover");
                                    }, 200);
                                }
                            }
                        }, {
