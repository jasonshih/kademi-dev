controllerMappings
    .adminController()
    .path('/migrateDataKpollApp')
    .addMethod('POST', 'migrateData')
    .enabled(true)
    .build();
...
function migrateData(page, prams) {
    log.info('migrateData > page={}, prams={}', prams);
    ...
    try {
        ...
        result.status = false;
        result.messages = ['Error in migrating: ' + e];
    }
