...
controllerMappings
    ...
    .path('/vidsurvey/')
    .enabled(true)
    .defaultView(views.templateView('vidsurveyapp/manageSurveys.html'))
...
controllerMappings
    ...
    .defaultView(views.templateView('vidsurveyapp/surveyDetail.html'))
...
controllerMappings
    ...
    .enabled(true)
    .addPathResolver('surveyId', 'findSurvey')
    .defaultView(views.templateView('vidsurveyapp/surveyResult.html'))
    .addMethod('GET', 'getSurvey')
    .title('generateWebsiteTitle')
    .build();
...
controllerMappings.addComponent("vidsurveyapp/components", "vidsurveyForm", "html", "Shows survey form questions", "Ksurvey App component");