...
controllerMappings.addComponent("rewardstore/components", "pointsLeaderboardWeb", "html", "Shows points leaderboard that includes current participant, for a selected points bucket", "Reward Store");
