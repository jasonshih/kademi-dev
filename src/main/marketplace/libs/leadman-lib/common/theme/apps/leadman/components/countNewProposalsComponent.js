(function ($) {
    ...
    KEditor.components['countNewProposals'] = {
        settingEnabled: true,
        settingTitle: 'Count New Proposals',
        initSettingForm: function (form, keditor) {
            flog('initSettingForm "countNewProposals" component');
            
            var self = this;
            
            return $.ajax({
                url: '_components/countNewProposals?settings',
                type: 'get',
                dataType: 'HTML',
        ...
        showSettingForm: function (form, component, keditor) {
            flog('showSettingForm "countNewProposals" component');
