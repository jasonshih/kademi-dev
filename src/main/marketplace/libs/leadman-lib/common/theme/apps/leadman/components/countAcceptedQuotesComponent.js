(function ($) {
    ...
    KEditor.components['countAcceptedQuotes'] = {
        settingEnabled: true,
        settingTitle: 'Count Accepted Quotes',
        initSettingForm: function (form, keditor) {
            flog('initSettingForm "countAcceptedQuotes" component');
            
            var self = this;
            
            return $.ajax({
                url: '_components/countAcceptedQuotes?settings',
                type: 'get',
                dataType: 'HTML',
        ...
        showSettingForm: function (form, component, keditor) {
            flog('showSettingForm "countAcceptedQuotes" component');
