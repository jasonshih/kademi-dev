...
// forEach that can be used on nodeList
            ...
            fbUtils.fieldRender = function (fieldData, opts) {
                ...
                if (fieldData.type !== 'hidden') {
                    ...
                    fieldLabel = '<label for="' + fieldData.id + '" class="' + opts.labelClasses + ' fb-' + fieldData.type + '-label">' + fieldLabelText + ' ' + fieldRequired + ' ' + fieldDesc + '</label>';
                }
                ...
                if( fieldData.className == "checkbox") {
                    fieldData.className = "";
                } else {
                    fieldData.className += " " + opts.inputClasses;
                }

                flog("fieldData", fieldData);
                ...
                switch (fieldData.type) {
                    ...
                    case 'radio-group':
                        ...
                        flog("field: ", fieldData.type, fieldLabel, optionsMarkup);
                    ...
                    case 'autocomplete':
                        ...
                        fieldMarkup = fieldLabel + ' <div class="' + opts.inputContainerClass + '"><input ' + fieldDataString + '></div>';
                        break;
                    case 'color':
                    ...
                    case 'checkbox':      
                        ...
                        fieldMarkup = '<label for="' + fieldData.id + '" class="' + ' fb-' + fieldData.type + '-label">' + fieldMarkup + fieldLabelText + ' ' + fieldRequired + ' ' + fieldDesc + '</label>';
                        
                        flog("render checkbox", fieldMarkup);
