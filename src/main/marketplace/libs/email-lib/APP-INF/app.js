...
controllerMappings.addComponent("email/components", "passwordResetLinkEDM")
        ...
        .categories("Email")
        .addDefaultAtt("padding-top", "10")
        .addDefaultAtt("padding-bottom", "10")
        .addDefaultAtt("padding-left", "10")
        .addDefaultAtt("padding-right", "10")
        .addDefaultAtt("inner-padding-top", "10")
        .addDefaultAtt("inner-padding-bottom", "10")
        .addDefaultAtt("inner-padding-left", "10")
        .addDefaultAtt("inner-padding-right", "10")
        .addDefaultAtt("bg-color", "#ffffff")
        .addDefaultAtt("color", "#0000ff")
        .addDefaultAtt("button-text-color", "#ffffff")
        .addDefaultAtt("text-align", "center")
