...
WebUI.sendKeys(findTestObject('kademi-vladtest/input_newName'), WebUI.concatenate((([GlobalVariable.orgname, 'estore']) as String[])))
...
WebUI.click(findTestObject('kademi-vladtest/div_KCommerce'))
