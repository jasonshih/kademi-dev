...
WebUI.sendKeys(findTestObject('kademi-vladtest/input_newName'), WebUI.concatenate((([GlobalVariable.orgname, 'leads']) as String[])))
...
WebUI.click(findTestObject('kademi-vladtest/div_KLeadman'))
