...
function addPageToList(pageName, href, title) {
    ...
    $('#page-list').append(
            ...
            '<a href="' + newFileName + '" class="btn btn-info btn-sm btn-edit-page"><i class="fa fa-edit"></i> Edit</a>' +
            '<button type="button" class="btn btn-info btn-sm dropdown-toggle" data-toggle="dropdown"> <span class="caret"></span></button>' +
            '<ul class="dropdown-menu pull-right" role="menu">' +
            '<li><a href="' + newFileName + '" class="btn-edit-page" title="Edit page"><i class="fa fa-edit"></i> Edit</a></li>' +
            '<li><a href="' + newFileName + '?goto" target="_blank" title="View page"><i class="clip-eye"></i> View</a></li>' +
            '<li class="divider"></li>' +
            '<li><a href="' + href + '" class="btn-delete-page" title="Delete page"><i class="fa fa-times"></i> Delete</a></li>' +
            '</ul>' +
            '</div>' +
            '</aside>' +
            '</article>'
